...
[_RAISE] = LAYOUT_complicated(
    KC_EXLM,    KC_AT,  KC_HASH,    KC_DOLLAR,KC_PERCENT,    KC_CIRCUMFLEX,KC_AMPERSAND,   KC_ASTERISK,   KC_LBRACKET,   KC_RBRACKET ,
    KC_TAB,  KC_MS_L,    KC_MS_D,KC_BTN1,  KC_BTN2,     KC__VOLUP, KC__VOLDOWN,   KC_MFFD,   KC__MUTE,   KC_DOUBLE_QUOTE ,
    KC_LBRC,KC_RBRC,KC_LPRN,KC_RPRN,KC_AMPR,    KC_MS_L, KC_MS_U,   KC_MS_D,   KC_MS_R,   KC_PLUS ,
